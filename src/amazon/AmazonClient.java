...
public class AmazonClient {
	...
	public void createBucket(String userId) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException{
		...
		ObjectSaver.saveBucketID(bucketName, userId);
